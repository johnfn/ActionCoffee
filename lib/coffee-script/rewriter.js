  ...
  exports.Rewriter = (function() {
    ...
    /*
      removeTypeParens: () ->
        ...
        for l in lines
          if l.indexOf('CALL_START') < l.indexOf('=')
            l.splice(l.indexOf('CALL_START'))
            l.splice(l.lastIndexOf('CALL_END'))
    
        @tokens = [].concat.apply(lines)
    */
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        tag = token[0];
        if (tag === 'PARAM_START') {
          return this.detectEnd(i + 1, function(token) {
            return token === 'PARAM_END';
          }, function(token, idx) {
            return idx - i;
          });
        }
