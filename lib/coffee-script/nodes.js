...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, Interface, InterfaceDecl, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, TypeExpression, UTILITIES, Value, While, YES, compact, d, del, ends, extend, flatten, last, merge, multident, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  d = function(o) {
    return console.log(require('util').inspect(o));
  };
  ...
  exports.InterfaceDecl = InterfaceDecl = (function(_super) {

    __extends(InterfaceDecl, _super);

    function InterfaceDecl(funcName, returnType, params) {
      this.funcName = funcName;
      this.returnType = returnType;
      this.params = params;
    }

    InterfaceDecl.prototype.compile = function(o) {
      var p;
      this.typedParams = ((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.params;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          p = _ref2[_i];
          _results.push(p.asTypeExpression().compile(o));
        }
        return _results;
      }).call(this)).join(", ");
      return "" + o.indent + "function " + this.funcName.value + "(" + this.typedParams + "):" + this.returnType.value + ";";
    };
  ...
  exports.Interface = Interface = (function(_super) {

    __extends(Interface, _super);

    function Interface(name, declarations) {
      this.name = name;
      this.declarations = declarations;
    }

    Interface.prototype.compile = function(o) {
      var result;
      o.indent += TAB;
      result = "public interface " + this.name.value + " \{\n";
      result += ((function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.declarations;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          d = _ref2[_i];
          _results.push(d.compile(o));
        }
        return _results;
      }).call(this)).join("\n");
      return result += "\n\}";
  ...
  exports.Class = Class = (function(_super) {
    ...
    function Class(variable, parent, body, implementList) {
      this.variable = variable;
      this.parent = parent;
      this.body = body != null ? body : new Block;
      this.implementList = implementList != null ? implementList : [];
      this.boundFuncs = [];
      this.body.classBody = true;
      this["implements"] = implementList;
    }
    ...
    Class.prototype.compileNode = function(o) {
      var call, decl, i, implementCode, lname, name, _ref2;
      o.indent += TAB;
      ...
      */
      ...
      implementCode = "";
      if (this.implementList.length) {
        implementCode = " implements " + ((function() {
          var _i, _len, _ref3, _results;
          _ref3 = this.implementList;
          _results = [];
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            i = _ref3[_i];
      ...
      return "public class " + name + (this.parent ? ' extends ' + this.parent.base.value : "") + implementCode + " \{\n " + (this.body.compile(o)) + "\}";
    };
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    function Assign(variable, value, context, options, typedecl) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (!this.context) {
        ...
        if (!(typeof varBase.hasProperties === "function" ? varBase.hasProperties() : void 0)) {
          if (this.param) {
            o.scope.add(name, 'var', false, this.typedecl.value);
          } else {
            o.scope.find(name, this.typedecl.value);
          }
        }
      }
  ...
  exports.TypeExpression = TypeExpression = (function(_super) {

    __extends(TypeExpression, _super);

    function TypeExpression(typeExpression, identifier) {
      this.typeExpression = typeExpression;
      this.identifier = identifier;
    }

    TypeExpression.prototype.compileNode = function(o) {
      return this.identifier.compile();
    };

    TypeExpression.prototype.isComplex = NO;
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag, vis, returnType) {
      this.params = params || [];
      ...
      this.returnType = returnType != null ? returnType.value : void 0;
      this.vis = vis;
    }
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, name, p, param, params, ref, returnAnnotation, splats, typedParams, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      returnAnnotation = this.returnType && !this.ctor ? ":" + this.returnType : "";
      code = "" + this.vis + (this["static"] ? 'static ' : '') + "function";
  ...
  exports.TypeExpression = TypeExpression = (function(_super) {
    ...
    function TypeExpression(type, identifier) {
      this.type = type;
      this.identifier = identifier;
    }

    TypeExpression.prototype.compile = function(o) {
      return "" + (this.identifier.compile()) + ":" + this.type;
    };
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat, type) {
      var _ref2;
      this.name = name;
      this.value = value;
      this.splat = splat;
    ...
    Param.prototype.children = ['name', 'value', 'type'];

    Param.prototype.compile = function(o) {
      if (this.type) {
        return "" + (this.name.compile(o, LEVEL_LIST)) + ":" + this.type;
      } else {
        return this.name.compile(o, LEVEL_LIST);
      }
    };

    Param.prototype.asTypeExpression = function(o) {
      return new TypeExpression(this.type, this.asReference());
    };
